...
python scrape_and_notify.py --date %DATE% --sports football basketball volleyball handball rugby hockey --to jakub.majka.zg@gmail.com --from-email jakub.majka.zg@gmail.com --password "vurb tcai zaaq itjx" --away-team-focus --only-form-advantage --headless
